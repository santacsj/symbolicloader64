...
Learn C64 assembly the hard way, by programming on paper :). You are the assembler, but this short BASIC program can automate the anoying address calculations for you.
