...
- Outputs formatted BASIC DATA lines in Symbolic Machine Code Loader syntax, ready for pasting it into VICE
- Saves the edited source code to browser local storage
- Uses [ace.c9.io](https://ace.c9.io/) for the code editor (Thanks, guys!)

## Syntax

The syntax is the same as the Symbolic Machine Code Loader, except ...
